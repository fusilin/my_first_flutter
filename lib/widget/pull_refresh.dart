...
class PullAndPush extends StatefulWidget {
  ...
  PullAndPush(
      ...
      this.tipText: "松手即可刷新",
      this.refreshIconPath: "assets/images/refresh.png",
      ...
      ..addListener(() {
        ...
        setState(() {
          if (topItemHeight > _refreshHeight) {
            ...
            topItemHeight =
                _refreshHeight + shrinkageDistance * animation.value;
              ...
              onNotification: (ScrollNotification notification) {
                ...
                if (notification is ScrollUpdateNotification &&
                  ...
                  setState(() {
                    ...
                    if (topItemHeight + notification.dragDetails.delta.dy / 2 <
                        0.0) {
                      topItemHeight = 0.0;
                      widget.scrollPhysicsChanged(
                          new AlwaysScrollableScrollPhysics());
                    } else {
                      //当刷新布局可见时，让头部刷新布局的高度+delta.dy(此时dy为负数)，来缩小头部刷新布局的高度
                      topItemHeight =
                          topItemHeight + notification.dragDetails.delta.dy / 2;
                    }
                  });
                  ...
                  setState(() {
                    ...
                    if (bottomItemHeight -
                            notification.dragDetails.delta.dy / 2 <
                        0.0) {
                      bottomItemHeight = 0.0;
                      widget.scrollPhysicsChanged(
                          new AlwaysScrollableScrollPhysics());
                  ...
                  if (notification.overscroll < 0.0 && bottomItemHeight < 0.5) {
                    setState(() {
                      if (notification.dragDetails.delta.dy / 2 +
                              topItemHeight <
                          0.0) {
                        topItemHeight = 0.0;
                        widget.scrollPhysicsChanged(
                        ...
                        if (topItemHeight > 150.0) {
                          ...
                          topItemHeight =
                              notification.dragDetails.delta.dy / 6 +
                                  topItemHeight;
